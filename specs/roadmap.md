...
| 2 | Share invite link | Not started | The invite link is the only way participants reach a poll; small, and follows creation directly. |
| 3 | Join poll with nickname | Not started | Entry point for every participant (guests and other registered users); needed before anyone can answer. |
